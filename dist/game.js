...
Card = (function() {
  ...
  Card.prototype.render = function(context, x, y, w, h) {
    context.fillStyle = this.color;
    context.fillRect(x, y, w, h);
    return context.fillStyle = config.background;
  };
...
}).call(this,require("C:\\projects\\little-game\\node_modules\\browserify\\node_modules\\insert-module-globals\\node_modules\\process\\browser.js"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/card.coffee","/")
},{"./config.coffee":7,"C:\\projects\\little-game\\node_modules\\browserify\\node_modules\\insert-module-globals\\node_modules\\process\\browser.js":4,"buffer":1,"lodash":5}],7:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
var $, boardSize, columns, dealerSize, rows;
...
Dealer = (function() {
  ...
  Dealer.prototype.display = function() {
    var x;
    x = config.canvasWidth - config.dealerWidth;
    return this.currentCard.render(config.context, x, 30, config.dealerWidth, config.dealerHeight);
  };
...
}).call(this,require("C:\\projects\\little-game\\node_modules\\browserify\\node_modules\\insert-module-globals\\node_modules\\process\\browser.js"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/dealer.coffee","/")
},{"./card.coffee":6,"./config.coffee":7,"./gameEvents.coffee":10,"C:\\projects\\little-game\\node_modules\\browserify\\node_modules\\insert-module-globals\\node_modules\\process\\browser.js":4,"buffer":1}],9:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
var availableFigures;

module.exports = availableFigures = [
  {
    name: 'Vertical Bar',
    figure: '00102030',
    points: 20
  }, {
    name: '5x Vertical Bar',
    figure: '00102030',
    points: 35
  }, {
    name: '6x Vertical Bar',
    figure: '0010203040',
    points: 50
  }, {
    name: 'Horizontal Bar',
    ...
    name: '5x Horizontal Bar',
    figure: '00010203',
    points: 35
  }, {
    name: '6x Horizontal Bar',
    figure: '0001020304',
    points: 50
  }, {
    name: 'Cross',
...
}).call(this,require("C:\\projects\\little-game\\node_modules\\browserify\\node_modules\\insert-module-globals\\node_modules\\process\\browser.js"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/formations.coffee","/")
},{"C:\\projects\\little-game\\node_modules\\browserify\\node_modules\\insert-module-globals\\node_modules\\process\\browser.js":4,"buffer":1}],10:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
var gameEvents, tickStream;
...
}).call(this,require("C:\\projects\\little-game\\node_modules\\browserify\\node_modules\\insert-module-globals\\node_modules\\process\\browser.js"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/gameEvents.coffee","/")
},{"C:\\projects\\little-game\\node_modules\\browserify\\node_modules\\insert-module-globals\\node_modules\\process\\browser.js":4,"buffer":1}],11:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
var $, Card, Grid, Tile, config, dealer, gameEvents, h, _,
  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
...
Grid = (function() {
  function Grid() {
    ...
    for (row = _i = 0, _ref = config.rows - 1; 0 <= _ref ? _i <= _ref : _i >= _ref; row = 0 <= _ref ? ++_i : --_i) {
      ...
      for (column = _j = 0, _ref1 = config.columns - 1; 0 <= _ref1 ? _j <= _ref1 : _j >= _ref1; column = 0 <= _ref1 ? ++_j : --_j) {
  ...
  Grid.prototype.streamConnected = function() {
    ...
    self = this;
    return canvasClick.map(function(e) {
      var result, tile, _i, _len, _ref;
      result = false;
      _ref = self._grid;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        tile = _ref[_i];
        if (tile.containsPoint.apply(tile, h.mouseToScreen(e.x, e.y))) {
          result = tile;
        }
      }
      return result;
    }).truethy().map(function(tile) {
      var connected;
      tile.place(dealer.deal());
      return connected = tile.getConnected();
    });
  };
...
score.subscribe(function(points) {
  return h.interpolateProperty(scoreAnimation, points);
});

scoreAnimation.subscribe(function(points) {
  return $.display.textContent = points;
});
...
_ref = document.querySelectorAll('[id]');
for (_i = 0, _len = _ref.length; _i < _len; _i++) {
  $el = _ref[_i];
  $[$el.id] = $el;
}
...
Tile = (function() {
  function Tile(w, h, x, y, row, column, _grid) {
    this.w = w != null ? w : 10;
    this.h = h != null ? h : 10;
    this.x = x != null ? x : 0;
    this.y = y != null ? y : 0;
    ...
    this.column = column;
    this._grid = _grid;
    this.getConnected = __bind(this.getConnected, this);
  ...
  Tile.prototype.drawFrame = function() {
    ...
    return c.context.strokeRect(this.x, this.y, this.w, this.h);
  };

  Tile.prototype.draw = function() {
    if (this.card) {
      this.card.render(c.context, this.x, this.y, this.w, this.h);
    }
    return this;
  };
  ...
  Tile.prototype.highlight = function(delay) {
    var self;
  ...
  Tile.prototype.neighbours = function() {
    return [this._grid.getTile(this.row - 1, this.column), this._grid.getTile(this.row + 1, this.column), this._grid.getTile(this.row, this.column - 1), this._grid.getTile(this.row, this.column + 1)];
  };

  Tile.prototype.getConnected = function(connected) {
    var batch, card, n, neighbours, t, _i, _j, _len, _len1;
    if (this.vacant) {
      return void 0;
    }
    if (!connected) {
    ...
    return _(connected).union().value();
  };

  Tile.prototype.place = function(card) {
    this.vacant = false;
    this.card = card;
    this.draw();
    return this;
...
}).call(this,require("C:\\projects\\little-game\\node_modules\\browserify\\node_modules\\insert-module-globals\\node_modules\\process\\browser.js"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/tile.coffee","/")
},{"./config.coffee":7,"C:\\projects\\little-game\\node_modules\\browserify\\node_modules\\insert-module-globals\\node_modules\\process\\browser.js":4,"buffer":1,"lodash":5}]},{},[13])